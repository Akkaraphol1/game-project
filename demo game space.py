...
def draw(): # Pygame Zero draw function
    ...
    if gameStatus == 3:
        ...
        sg = "GAMING RULES"
        screen.draw.text(sg,center=(400,350),fontsize=80,color='blue')

    if gameStatus == 4:
        screen.blit('bg1', (0, 0))
        lg = "CHARACTER"
        screen.draw.text(lg,center=(400,350),fontsize=80,color='blue')

    if gameStatus == 5:
        screen.blit('backdrop800', (0, 0))
        rg = "PROVIDER"
        screen.draw.text(rg,center=(400,350),fontsize=80,color='blue')
